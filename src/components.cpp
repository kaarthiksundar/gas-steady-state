...
Pipe::Pipe(int id, std::string name, int fnode, int tnode,
    ...
    _si_units = false; _standard_units = false; _per_unit = false;
    if (units == 0) _si_units = true;
    else _standard_units = true;
    _status = true;
};
...
bool Pipe::is_standard() const { return _standard_units; };
bool Pipe::is_si() const { return _si_units; };
...
void Pipe::make_per_unit() {};
void Pipe::make_standard() {};
void Pipe::make_si() {};
...
bool Node::is_standard() const { return _standard_units; };
bool Node::is_si() const { return _si_units; };
...
std::ostream& operator<<(std::ostream& os, const Node &node) {
    ...
    "slack: " << node._slack << ", " <<
    "standard_units: " << node._standard_units << ", " <<
    "si_units: " << node._si_units << ", " <<
    "per_unit: " << node._per_unit << ", " <<
    "status: " << node._status << ")" << std::endl;
    return os;
};

void Node::make_standard() {};
void Node::make_si() {};
void Node::make_per_unit() {};
...
Compressor::Compressor(int id, std::string name, int fnode, int tnode,
    ...
    _status = true;
    if (_si_units) { _diameter = 1.0; _length = 250.0; _friction_factor = 0.001; }
...
bool Compressor::is_standard() const { return _standard_units; };
bool Compressor::is_si() const { return _si_units; };
...
void Compressor::make_per_unit() {};
void Compressor::make_standard() {};
void Compressor::make_si() {};
