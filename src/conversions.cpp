...
double ConversionFactors::pascal_to_psi() const { return 1.0/_psi_to_pascal; };
...
double ConversionFactors::get_molecular_weight_air() const { return _molecular_weight_air; };
...
double ConversionFactors::kgps_to_mmscfd() const { return 1.0/_mmscfd_to_kgps; };
...
_space_scaling(space_scaling) {};

double ScalingFactors::get_pressure_scaling() const { return _pressure_scaling; };
...
ScalingFactors build_scaling_factors(double si_pressure_scaling, const ConversionFactors &cf) {
    ...
    return ScalingFactors(si_pressure_scaling, flow_scaling, time_scaling, space_scaling);
};
