...
class Model {
  ...
  public:
    ...
    evaluate_objective_gradient(const double *);
    ...
    std::vector<std::tuple<int, double>>
    evaluate_constraint_gradient(int, const double *);

    /* eval_h functions (none so far - automatic hessian computations not
     * implemented) */
    std::vector<std::pair<int, int>> get_hessian_sparsity_pattern();
    std::vector<std::tuple<int, int, double>>
    evaluate_objective_hessian(const double *);
    std::vector<std::tuple<int, int, double>>
    evaluate_constraint_hessian(int, const double *);
    ...
    add_variables(int, std::vector<std::string>);
